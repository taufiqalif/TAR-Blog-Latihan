...
<div class="col-lg-8">
  <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      <label for="category" class="form-label fs-6 fw-bolder">Category</label>
    ...
    <div class="mb-3">
      <label for="image" class="form-label fs-6 fw-bolder">Post Image</label>
    ...
    <div class="mb-3">
      <label for="body" class="form-label fs-6 fw-bolder">Body</label>
      ...
      @enderror
      <trix-editor input="body" class="bg bg-white"></trix-editor>
    </div>
